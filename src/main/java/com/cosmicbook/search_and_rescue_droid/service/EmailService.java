...
public class EmailService {
    ...
    public void sendForgotPasswordEmail(String toEmail, String username, String otp) {
        String subject = "Password resetting process for your account has been initiated";
            ...
            <body>
                <div class="email-container">
                    <div class="email-content">
                        ...
                        <div class="body">
                            <p>Hi, <strong>%s</strong> 👋</p>
                            <p>We received a <strong>reset password</strong> request for your account, please verify your email to continue.</p>
                            <p>Please use the OTP below to verify your email (valid for 10 minutes):</p>
                            <div class="otp">%s</div>
                            <p>If you did not make this request, feel free to ignore this email.</p>
                        </div>
